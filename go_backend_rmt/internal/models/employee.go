...
type Employee struct {
	...
	DesignationID *int       `json:"designation_id,omitempty" db:"designation_id"`
...
type CreateEmployeeRequest struct {
	...
	DesignationID *int                             `json:"designation_id,omitempty"`
	Salary        *float64                         `json:"salary,omitempty"`
	HireDate      *time.Time                       `json:"hire_date,omitempty"`
	IsActive      *bool                            `json:"is_active,omitempty"`
	LeaveBalance  *float64                         `json:"leave_balance,omitempty"`
	AppUser       *CreateAppUserForEmployeeRequest `json:"app_user,omitempty"`
}
...
type CreateAppUserForEmployeeRequest struct {
	Create       bool   `json:"create"`
	Username     string `json:"username" validate:"required,min=3,max=100"`
	Email        string `json:"email" validate:"required,email"`
	TempPassword string `json:"temp_password" validate:"required,min=6,max=200"`
