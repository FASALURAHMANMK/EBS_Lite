...
func productRow() []driver.Value {
	return []driver.Value{1, 1, nil, nil, nil, nil, nil, "LOOSE", "LOOSE", 1.0, 1.0, false, "Test", nil, nil, nil, nil, 0, nil, nil, false, "VARIANT", true, 1, nil, 1, time.Now(), time.Now(), false}
}
