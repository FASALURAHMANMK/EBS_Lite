...
func (c *barcodeMockConn) QueryContext(ctx context.Context, query string, args []driver.NamedValue) (driver.Rows, error) {
	...
	if strings.Contains(lower, "from products") {
		if strings.Contains(lower, "default_supplier_id") || strings.Contains(lower, "tax_id") {
			...
			vals := []driver.Value{int64(1), int64(1), "PRODUCT", nil, nil, nil, nil, nil, "LOOSE", "LOOSE", float64(1), float64(1), false, "name", "sku", "desc", float64(0), float64(0), int64(0), nil, nil, false, "VARIANT", true, int64(1), nil, "synced", time.Now(), time.Now(), false, nil, int64(1)}
		...
		vals := []driver.Value{int64(1), int64(1), "PRODUCT", nil, nil, nil, nil, nil, "LOOSE", "LOOSE", float64(1), float64(1), false, "name", "sku", "desc", float64(0), float64(0), int64(0), nil, nil, false, "VARIANT", true, int64(1), nil, "synced", time.Now(), time.Now(), false}
		return &barcodeMockRows{cols: cols, vals: [][]driver.Value{vals}}, nil
	}
	if strings.Contains(lower, "from product_barcodes") {
