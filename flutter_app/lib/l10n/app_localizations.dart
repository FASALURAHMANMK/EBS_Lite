...
abstract class AppLocalizations {
  ...
  /// No description provided for @companySettingsUpdated.
  ///
  /// In en, this message translates to:
  /// **'Company settings updated'**
  String get companySettingsUpdated;
  ...
  /// No description provided for @receiptLanguageLabel.
  ///
  /// In en, this message translates to:
  /// **'Receipt Language'**
  String get receiptLanguageLabel;
